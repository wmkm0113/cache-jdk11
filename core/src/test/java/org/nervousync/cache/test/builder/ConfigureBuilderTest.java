	...
	public void test000Config() {
		try {
			CacheConfig cacheConfig = CacheConfigBuilder.newBuilder()
					...
					.serverBuilder("ServerAddress", 11211).weight(1).confirm()
					.serverBuilder("ServerAddress1", 11211).weight(1).confirm()
					.serverBuilder("ServerAddress1", 11211).weight(2).confirm()
